...
import com.labcnt.sttq.Toggle.ReadingToggleButton;
...
public class ReadingAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<ReadingModel> mQuestionList;


    public ReadingAdapter(Context context, ArrayList<ReadingModel> questionList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View questionView = LayoutInflater.from(mContext)
                .inflate(R.layout.reading_card_layout, parent, false);
        return new QuestionViewHolder(questionView);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        final ReadingModel question = mQuestionList.get(position);
    ...
    class QuestionViewHolder extends RecyclerView.ViewHolder {
        ...
        ReadingToggleButton mTableLayout;
